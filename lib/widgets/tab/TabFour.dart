...
class _TabFour extends State<TabFour> with AutomaticKeepAliveClientMixin{
  ...
  loadData(dynamic lastCursor)async{
    await HttpsUtils.getInstance().getHttp(blockchain,{"lastCursor": lastCursor, "pageSize": pageSize},(data){
